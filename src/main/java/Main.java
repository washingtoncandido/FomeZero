...
//		Gerente adriano = new Gerente(5,"adriano",
//				"Rua F o", 100000.5,null, "ADM");

        Entregador fred = new Entregador(1, "Fred");

        Entregador jose = new Entregador(2, "jose");


        entregadorDAO.save(fred);
        entregadorDAO.save(jose);

//
        entregadorDAO.updateEntregador(1,"adrianoSilva");

//        System.out.println(entregadorprocurado);
        entregadorDAO.deletEntregador(2);



//        entregadorDAO.deletEntregador();

        entregadorDAO.fecharEntityManager();
//		Entregador entregadorlocalizado = entregadorDAO.searchPorId(1);
//		System.out.println(entregadorlocalizado);
    }
...
//		Ingredientes batataIngl = new Ingredientes(8,"batata Inglesa","normal",conjuntoProdutos,123,"PA");
